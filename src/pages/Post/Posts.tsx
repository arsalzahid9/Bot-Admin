...
import { CheckCircle, XCircle, Plus, ChevronLeft, ChevronRight, RefreshCw } from "lucide-react";
                ...
                <tr key={post.id}>
                  <td className="px-6 py-4">
                    <div className="flex items-center">
                      <div className="truncate" style={{ maxWidth: '350px' }}>
                        <a
                  ...
                  <td className="px-6 py-4 text-sm font-medium">
                    <div className="flex space-x-2">
                      <button
                        ...
                        className={`text-green-600 hover:text-green-900 ${post.status === "approve" || post.status === "reject"
                      ...
                      <button
                        ...
                        className={`text-red-600 hover:text-red-900 ${post.status === "approve" || post.status === "reject"
                          ? "opacity-50 cursor-not-allowed"
                          : ""
                          }`}
                        disabled={post.status === "approve" || post.status === "reject"}
